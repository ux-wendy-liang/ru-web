...
export interface Project {
  ...
  tags?: string[]; // Capability tags shown on homepage card (e.g., "Product Thinking", "Interaction Design")
  role: string;
  duration: string;
  team: string;
...
export const projects: Project[] = [
  {
    ...
    shortDescription: 'Led LinkedIn\'s publisher portal from 0→1 — expanding beyond SDK integration into a full self-serve ad platform.',
    tags: ['Product Thinking', '0→1 Strategy', 'Cross-team Alignment', 'End-to-End Design'],
  ...
  },
  {
    ...
    shortDescription: 'Challenged a quick-fix proposal with research, redesigning the dashboard into a dual-experience — lifting self-serve to 71%.',
    tags: ['User Research', 'Product Thinking', 'Interaction Design'],
  ...
  },
  {
    ...
    shortDescription: 'Study groups saw 50%+ dropout from overly academic materials. I wrote the PRD and built a full-stack learning platform in 4 days — now live with 260 users.',
    tags: ['Product Thinking', 'End-to-End Builder', 'AI Prototyping'],
    role: 'Product Designer\n+ Builder (Vibe Coding)',
    duration: '1 year observing + 4 days building',
  ...
  },
  {
    ...
    shortDescription: 'Built LinkedIn\'s first tool for taxonomists — replacing error-prone spreadsheets with a structured system powering job-member matching.',
    tags: ['User Research', '0→1 Design'],
    role: 'User researcher, UX, UI',
    duration: '5 Weeks',
  ...
  },
  {
    ...
    year: 2013,
    cover: '/images/qq/qq-01.png',
    shortDescription: 'A redesign of Tencent\'s QQ mobile app, in collaboration with Frog Design — user interviews, prototyping, visual design, and usability testing to solve the problem of user churn.',
    role: 'User Interviews\n+ Prototyping\n+ Visual Design',
    duration: 'Apr – Dec 2012',
    team: 'Tencent × Frog Design',
    images: [
      '/images/qq/qq-02.png',
      '/images/qq/qq-03.png',
      '/images/qq/qq-04.png',
